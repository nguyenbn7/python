...
def convert_to_png(jpeg_image: str, dest_folder: str):
    try:
        image_path = Path(jpeg_image).resolve()
        ...
        img.save(dest_path / f"{image_name}.png", format="png")
...
def convert_all_to_png(jpeg_images: List[str], dest_folder: str):
