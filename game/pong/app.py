...
A classic video game https://en.wikipedia.org/wiki/Pong.
Refer from cs50 game
"""

import pygame

from config import PADDLE_SPEED, WINDOW_HEIGHT, WINDOW_WIDTH
...
def main():
    ...
    large_font = pygame.font.Font("./fonts/font.ttf", 16)
    score_font = pygame.font.Font("./fonts/font.ttf", 70)
